...
const getSuppliers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const supplierDataLength = (yield SuppliersModel_1.default.find({})).length;
...
const addSupplier = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const body = req.body;
        const isSupplierMa = yield SuppliersModel_1.default.find({
            supplierMa: body.supplierMa,
        });
        if (!isSupplierMa) {
            return res.status(400).json({
                code: 1011,
                message: enum_1.MESSAGE_SUPPLIER_ENUM.WARNING_SUPPLIER_EMAIL,
            });
        }
